(function () {
  ...
  window.WebCoolModuleRegistry.define("01-locks-context.js", [
    ...
    "              ? (api.folderCopy + '?path=' + encodeURIComponent(remoteDiskClipboardPath) + '&folder=' + encodeURIComponent(path))",
    "              : (api.fileCopy + '?file=' + encodeURIComponent(remoteDiskClipboardPath) + '&folder=' + encodeURIComponent(path));",
    "            if (overwrite) {",
    "              url += '&overwrite=1';",
    "            }",
